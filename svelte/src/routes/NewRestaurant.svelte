<script>
  import { createRestaurant } from '../lib/api.js';
  ...
  async function submitRestaurant() {
    ...
    try {
      ...
      alert("Reštaurácia bola pridaná!");
      goTo('restaurants');
    } catch (error) {
      console.error("Chyba pri vytváraní reštaurácie:", error);
      alert("Nepodarilo sa pridať reštauráciu. Skontrolujte dáta a skúste znova.");
    }
  }
...
<div class="form-container">
  <h1>Pridať reštauráciu</h1>
  <form on:submit|preventDefault={submitRestaurant}>
    ...
    <div class="form-group">
      <label for="images">Obrázky reštaurácie:</label>
